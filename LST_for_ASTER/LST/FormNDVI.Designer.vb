...
Partial Class FormNDVI
    ...
    Private Sub InitializeComponent()
        ...
        Me.Label1.Text = "Path to the ASTER Band 2 Reflectance file (data type float)"
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Path to the ASTER Band 3N Reflectance file (data type float)"
        '
        'Label3
        '
        ...
        Me.Text = "NDVI Calculation from ASTER Imagery"
